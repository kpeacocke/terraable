...
# This module does not provision Parallels Desktop VMs directly.
# Phase 2 will add Parallels provider/resource definitions once a community provider matures.
