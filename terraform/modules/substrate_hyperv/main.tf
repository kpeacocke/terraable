...
# This module does not provision Hyper-V VMs directly.
# Phase 2 will add the hyperv provider and VM/switch resource definitions.
# See docs/handoff-contract.md for the contract schema.

locals {
  environment_name = var.environment_name
  api_endpoint     = "https://${var.host_system}:5986"
}
