...
- `portal`: Portal implementation work.
- `security`: Hardening, compliance, and controls.
- `eda`: Event-Driven Ansible work.
- `demo`: Demo flow and presenter support work.
- `backend`: Backend and orchestration work.
